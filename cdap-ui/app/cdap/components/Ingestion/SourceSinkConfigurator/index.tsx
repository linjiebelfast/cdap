...
const SourceSinkConfig: React.FC<ISourceSinkConfigProps> = ({
  ...
  console.log('SCGPRo', sourceCGProps);
  const sinkCGProps = {
      ...
      <div className={classes.propsContainer}>
        <If condition={sourceBP && selectedSource}>
          <div className={classes.propsRenderBlock}>
            <WidgetRenderer title="Source" plugin={selectedSource} cgProps={sourceCGProps} />
          </div>
        </If>
        <If condition={sinkBP && selectedSink}>
          <div className={classes.propsRenderBlock}>
            <WidgetRenderer title="Sink" plugin={selectedSink} cgProps={sinkCGProps} />
          </div>
        </If>
      </div>
    </div>
